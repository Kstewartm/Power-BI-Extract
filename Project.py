...
## ==================================================
# file C:/Users/MAQ/Documents/Akash Rajak/Megha Team Assignment/AkashRamanandRajak_EMPN0357.pbix
# pbit path C:\Users\MAQ\Documents\Akash Rajak\Megha Team Assignment\AkashRamanandRajak_EMPN0357.pbit

# p = Path(file)
# # print(p)
# p.rename(p.with_suffix('.pbit'))
#
# s = str(p)
# # print(type(s), s)
#
...
openai.api_key = "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"
